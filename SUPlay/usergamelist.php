...
<div class="row">
<a href="index.php" class="btn mb-5 bg-success text-white">Back to home page</a>
...
<h5>Game list</h5>
    ...
    while ($rows = mysqli_fetch_assoc($result))
    {
        ...
        "<div class='project-info-box mt-0'>" .
            "<h5>$name</h5>" .
            "<p class='mb-0'>Average rate: $avr_rate</p>".
            "<p class='mb-0'>Release date: $release_date</p>".
            "<p class='mb-0'>Time played: $time_played</p>".
            "<a href='gamedetail.php?gameid=$game_id' class='btn btn-primary mb-0'>Go detail page</a>".
        "</div>" .
        "</div>";
    }
    ?>
